    ...
    <div className="container mt-4">
      ...
      <ul className="list-group">
        {negociacoes.map((negociacao) => (
          ...
          >
            <div>
              <strong>ID da Negociação:</strong>{" "}
              {negociacao.negociacao.negociacaoId} <br />
              <strong>Comprador:</strong>{" "}
              {negociacao.negociacao.usuarioIdComprador} <br />
              <strong>Vendedor:</strong>{" "}
              {negociacao.negociacao.usuarioIdVendedor} <br />
              <strong>ID da Oferta:</strong> {negociacao.negociacao.ofertaId}{" "}
              <br />
              <strong>Preço:</strong> {negociacao.oferta.preco} <br />
              <strong>Quantidade de Milhas:</strong>{" "}
              {negociacao.oferta.qtdMilhas} <br />
              ...
              {negociacao.oferta.compraOuVenda} <br />
              <strong>Confirmada:</strong>{" "}
              {negociacao.oferta.confirmada ? "Sim" : "Não"} <br />
            </div>
            <button

...
function OfertasMilhas() {
    ...
    axios
      ...
      .then((response) => {
        if (response.data.length === 0) {
          ...
          const companhiasUnicas = [...new Set(response.data.map(oferta => oferta.ciaAerea))].sort()
  ...
  const aplicarFiltros = () => {
    ...
    if (filtroCompanhia !== "todas") {
      resultado = resultado.filter(oferta => 
        oferta.ciaAerea === filtroCompanhia
      )
    }
  ...
  return (
    <div className="ofertas-container">
      <div className="ofertas-header">
        ...
        <p className="ofertas-subtitle">Encontre as melhores oportunidades para comprar ou vender suas milhas</p>
        ...
        <div className="filtros-grid">
          ...
          <div className="filtro-grupo">
            ...
            <div className="filtro-opcoes">
              <label className={`filtro-opcao ${filtroTipo === "todos" ? "ativo" : ""}`}>
                <input 
                  type="radio" 
                  name="tipo" 
                  value="todos" 
              ...
              <label className={`filtro-opcao ${filtroTipo === "compra" ? "ativo" : ""}`}>
                <input 
                  type="radio" 
                  name="tipo" 
                  value="compra" 
              ...
              <label className={`filtro-opcao ${filtroTipo === "venda" ? "ativo" : ""}`}>
                <input 
                  type="radio" 
                  name="tipo" 
                  value="venda" 
          ...
          <div className="filtro-grupo">
            <label htmlFor="companhia" className="filtro-label">Companhia aérea</label>
            <select 
              id="companhia" 
      ...
      <div className="resultados-info">
        {!loading && (
          <p>
            ...
            {(filtroTipo !== "todos" || filtroCompanhia !== "todas") && ' com os filtros aplicados'}
          </p>
        )}
      </div>
            ...
            {ofertasFiltradas.map((oferta) => (
              <div key={oferta.ofertaId} className="oferta-card">
                <div className="oferta-card-header">
                  <span className={`oferta-badge ${getBadgeClass(oferta.compraOuVenda)}`}>
                  ...
                  <div className="oferta-info">
                    <div className="oferta-info-item">
                      ...
                      <div>
                        ...
                        <span className="oferta-valor">{formatarPreco(oferta.preco)}</span>
                      </div>
                    </div>
                    ...
                    <div className="oferta-info-item oferta-milhas">
                      ...
                      <div>
                        ...
                        <span className="oferta-valor">{formatarMilhas(oferta.qtdMilhas)} milhas</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="oferta-card-footer">
                  <button className="btn-pegar-oferta" onClick={() => confirmaOferta(oferta.ofertaId)}>
                    Pegar Oferta

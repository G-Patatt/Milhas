...
router.get(
  "/usuario",
  authMiddleware,
  negociacaoController.getNegociacoesPorUsuario
); // Altere para não precisar de :usuarioId na URL
...
router.put("/:ratedId/:ratingID", negociacaoController.atualizarAvaliacoes);
